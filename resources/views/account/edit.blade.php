						...
						<div class="row">
							<div class="col-md-5 col-sm-4 col-12">
								<h3 class="no-padding text-center-480 useradmin">
									<a href="">
										<img id="userImg" class="userImg" src="{{ $authUser ? $authUser->photo_url : asset('images/user.jpg') }}" alt="user">&nbsp;
						...
						<div class="row">
							<div class="col-8">
								<div class="welcome-msg">
									<h3 class="page-sub-header2 clearfix no-padding">{{ t('Hello') }} {{ $authUser ? $authUser->name : 'User' }} ! </h3>
									<span class="page-sub-header-sub small">
		                                {{ t('You last logged in at') }}: {{ $authUser && $authUser->last_login_at ? \App\Helpers\Date::format($authUser->last_login_at, 'datetime') : 'N/A' }}
		                            </span>
								</div>
							</div>
